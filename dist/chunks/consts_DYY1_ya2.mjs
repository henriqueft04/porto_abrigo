...
const SITE = {"name":"Porto de Abrigo","site":"https://porto-de-abrigo.com","base":"/","trailingSlash":false,"googleSiteVerificationId":false};
                    const I18N = {"language":"pt","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Porto de Abrigo","template":"%s — Porto de Abrigo"},"description":"Candidatura à Junta Regional do Porto 2025-2028. Caminhar com TODOS. Servir cada Um. Uma equipa experiente e comprometida com o desenvolvimento do escutismo na região.","openGraph":{"type":"website","site_name":"Porto de Abrigo","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"@portodeabrigo","site":"@portodeabrigo","cardType":"summary_large_image"}};
